...
- `.gemini/agents/ml-specialist.md` -- Full agent (architecture, patterns, security)
- `.gemini/agents/align-specialist.md` -- LLM fine-tuning (companion package)
- `.gemini/agents/dataflow-specialist.md` -- ConnectionManager, database patterns
