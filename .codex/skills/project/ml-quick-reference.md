...
- `.codex/prompts/specialist-ml.md` -- Full agent (architecture, patterns, security)
- `.codex/prompts/specialist-align.md` -- LLM fine-tuning (companion package)
- `.codex/prompts/specialist-dataflow.md` -- ConnectionManager, database patterns
