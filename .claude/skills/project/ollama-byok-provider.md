...
- `workspaces/hr-ai-advisory/04-validate/round-14-ollama-todos-redteam.md` — plan red team
- `workspaces/hr-ai-advisory/04-validate/round-15-t129-security-review.md` — security review (shadow.py C1 regression)
